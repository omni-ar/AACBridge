...
\begin{enumerate}
    ...
    \item The three-state KV cache residency requires approximately 121.6~MB of additional native heap, a feasible budget on modern mobile devices with 8~GB RAM.
